...
export function ShareDialog({ projectId, canManageAccess = false, ownerDisplayName, trigger, open, onOpenChange }: ShareDialogProps) {
                ...
                <div className="p-6 pb-4">
                    ...
                    {canManageAccess ? (
                        ...
                        <div className="mb-6 rounded-lg border bg-muted/30 p-3 text-sm text-muted-foreground">
                            This project was shared with you{ownerDisplayName ? ` by ${ownerDisplayName}` : ""}. Only the real owner can change access.
                        </div>
                    )}
